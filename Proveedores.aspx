<%@ Page Title="" Language="C#" MasterPageFile="~/AdminProductos.Master" AutoEventWireup="true" CodeBehind="Proveedores.aspx.cs" Inherits="ControlInventario.Proveedores" %>
    ...
    <section class="card p-4 mb-4">
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <asp:Label ID="Label2" runat="server" CssClass="form-label" Text="Codigo de proveedor:"></asp:Label>
                <asp:TextBox ID="TbProducto" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-md-4 col-sm-12">
                <asp:Label ID="Label3" runat="server" CssClass="form-label" Text="Nombre/Razón Social:"></asp:Label>
                <asp:TextBox ID="TbRazon" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-md-4 col-sm-12">
                <asp:Label ID="Label1" runat="server" CssClass="form-label" Text="Identificación tributaria:"></asp:Label>
                <asp:TextBox ID="TbNIT" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <asp:Label ID="Label4" runat="server" CssClass="form-label" Text="Dirección:"></asp:Label>
                <asp:TextBox ID="TbDireccion" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-md-4 col-sm-12">
                <asp:Label ID="Label5" runat="server" CssClass="form-label" Text="Departamento:"></asp:Label>
            ...
            <div class="col-md-4 col-sm-12">
                <asp:Label ID="Label6" runat="server" CssClass="form-label" Text="Municipio:"></asp:Label>
                <asp:DropDownList CssClass="btn btn-light dropdown-toggle" ID="DropDownMuni" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownMuni_SelectedIndexChanged" Width="100%"></asp:DropDownList>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12">
                <asp:Label ID="Label7" runat="server" CssClass="form-label" Text="Nombre Contacto:"></asp:Label>
                <asp:TextBox ID="TbNomContacto" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <asp:Label ID="Label8" runat="server" CssClass="form-label" Text="Apellido Contacto:"></asp:Label>
                <asp:TextBox ID="TbApContacto" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <asp:Label ID="Label9" runat="server" CssClass="form-label" Text="Teléfono:"></asp:Label>
                <asp:TextBox ID="TbTelefono" CssClass="form-control" runat="server"></asp:TextBox>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12">
                <asp:Label ID="Label13" runat="server" CssClass="form-label" Text="Correo:"></asp:Label>
